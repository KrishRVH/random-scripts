 ...
 * raw extras. Based on current SprawlCommand control flow, in-place mutation is
 * needed to avoid extra allocations and keep a single authoritative argv
 * instance.
 *
 * Behavior highlights:
...
function resolveAlias(flag: string, aliases: Record<string, string>): string {
    return Object.prototype.hasOwnProperty.call(aliases, flag) ? aliases[flag] : flag;
}
